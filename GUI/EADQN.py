...
class DeepQLearner:
    def __init__(self, args, sess):
        logging.debug( 'Initializing the DQN...' )
    ...
    def build_dqn(self):
        ...
        with tf.variable_scope('prediction'):
            wn = self.words_num
            logging.debug( 'Initializing main network...' )
        ...
        with tf.variable_scope('target'):
            wn = self.words_num
            logging.debug( 'Initializing target network...' )
        ...
        with tf.variable_scope('pred_to_target'):
            logging.debug( 'Initializing pred_to_target...' )
            self.t_w_input = {}
            self.t_w_assign_op = {}
