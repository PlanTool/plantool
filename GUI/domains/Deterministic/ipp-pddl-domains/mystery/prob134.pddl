(DEFINE (PROBLEM STRIPS-MYSTY-A-22)
   (:DOMAIN MYSTERY-STRIPS)
   (:OBJECTS CHICKEN TOFU SHRIMP POPOVER HAM HAROSET PISTACHIO
             ENDIVE SNICKERS MUFFIN LEARNING EXCITEMENT ANXIETY HANGOVER
             GRIEF DEPRESSION PROSTATITIS ANGINA ANGER LACERATION
             JEALOUSY DREAD SCIATICA LONELINESS BOILS HANGOVER-2 ABRASION
             BOILS-4 GRIEF-1 MANITOBA BAVARIA BOSNIA PLUTO JUPITER NEPTUNE
             MARS)
   (:INIT (FOOD CHICKEN)
          (FOOD TOFU)
          (FOOD SHRIMP)
