(DEFINE (PROBLEM STRIPS-MYSTY-19)
   ...
   (:OBJECTS COD POPOVER PISTACHIO KALE POTATO TOFU HOTDOG SNICKERS
             ...
             HAROSET MUTTON BACON AESTHETICS SATISFACTION UNDERSTANDING
             TRIUMPH ENTERTAINMENT CURIOSITY LOVE LUBRICITY SATIETY
             ACHIEVEMENT LEARNING EMPATHY INTOXICATION EXCITEMENT LONELINESS
             ABRASION GRIEF DEPRESSION ANGER SCIATICA PROSTATITIS ANXIETY
             DREAD ANGINA HANGOVER BOILS BOSNIA GOIAS KENTUCKY MANITOBA
             ALSACE ARIZONA BAVARIA PENNSYLVANIA GUANABARA MORAVIA SATURN
             NEPTUNE MARS EARTH)
   (:INIT (FOOD COD)
          (FOOD POPOVER)
          (FOOD PISTACHIO)
