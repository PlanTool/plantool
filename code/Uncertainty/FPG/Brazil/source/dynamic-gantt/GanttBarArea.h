...
#ifndef gantt_bar_area
#define gantt_bar_area
...
/**
 * GanttBarArea draws a sorted list of GanttBar Containers.
 *
 *
 */
class GanttBarArea : public QWidget
{
	private:
			
	public:
		GanttBarArea (QWidget* parent = NULL) : QWidget (parent)
		{
