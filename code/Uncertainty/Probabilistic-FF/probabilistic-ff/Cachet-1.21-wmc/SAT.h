...
void SAT_SetVGO(SAT_Manager mng, vector< set<int> >);

void SAT_SetStaticHeuristic(SAT_Manager mng, bool);

void SAT_SetFarBacktrackFlag(SAT_Manager mng, bool);
...
void SAT_SetDynamicHeuristic(SAT_Manager mng, int);

void SAT_SetBacktrackFactor(SAT_Manager mng, double);
