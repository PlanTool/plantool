...
struct CDatabaseStats {
	...
	long64		num_solutions;	//	added by sang
	// unsigned num_unsatisfied_clause; // added by sang
};
...
//others
    ...
    ClauseIdx add_clause (int * lits, int n_lits, int gflag = 0, bool original = false);
