...
|
OPEN_PAREN  WHENPC_TOK  PERCENT adl_goal_description  adl_effect  CLOSE_PAREN
{
  /* july06: probabilistic!! conditional.
   */
  $$ = new_PlNode(WHEN);
  sscanf($3, "%lf", &($$->eff_p));
  $4->next = $5;
...
|
OPEN_PAREN  WHENP_TOK  PERCENT adl_effect  CLOSE_PAREN
{
  /* july06: probabilistic!! non-conditional.
   */
  $$ = new_PlNode(WHEN);
  sscanf($3, "%lf", &($$->eff_p));
  $$->sons = new_PlNode(TRU);
