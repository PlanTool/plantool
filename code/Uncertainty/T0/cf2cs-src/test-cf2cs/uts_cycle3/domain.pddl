...
;   :precondition (and)
   ...
   (and 
    ...
    (when (and (at-node n0) (edge-label n0 n2 ?label))
      (and  (at-node n2) (not (at-node n0)) (visited n2)))
    ...
    (when (and (at-node n2) (edge-label n2 n0 ?label))
      (and  (at-node n0) (not (at-node n2)) (visited n0)))
