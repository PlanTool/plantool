...
int main(int argc, char * * argv)
{
    ...
    cerr << "Due to certain modification of zChaff code, you are advised to use:"<<endl;
    cerr << "zverify_df CNF_File Resolve_Trace -core"<<endl;
    cerr << "for unsat core dump."<<endl;
    return 0;
}
