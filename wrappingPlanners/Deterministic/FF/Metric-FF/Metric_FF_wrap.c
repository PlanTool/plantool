...
/*-----------------------------------------------
              @(target):= _Metric_FF.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Metric_FF

#else
#  define SWIG_init    init_Metric_FF

#endif
#define SWIG_name    "_Metric_FF"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Metric_FF(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Metric_FF",&obj0)) SWIG_fail;
  res1 = SWIG_AsArgcArgv(obj0, SWIGTYPE_p_p_char, &argc1, &argv1, &owner1);
  if (!SWIG_IsOK(res1)) {
    arg1 = 0; arg2 = 0;
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "Metric_FF" "', argument " "1"" of type '" "int ARGC, char **ARGV""'");
  } else {
    arg1 = (int)(argc1);
    arg2 = (char **)(argv1);
  }
  result = (int)Metric_FF(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Metric_FF", _wrap_Metric_FF, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
