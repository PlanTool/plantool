(DEFINE (PROBLEM MYSTY-A-23)
   (:DOMAIN MYSTERY-TYPED)
   (:OBJECTS ORANGE WURST HAROSET HOTDOG GRAPEFRUIT KALE CHOCOLATE
             PEA PEAR ONION SNICKERS - FOOD
             CURIOSITY LUBRICITY EXCITEMENT - PLEASURE
             GRIEF PROSTATITIS SCIATICA DREAD HANGOVER DEPRESSION
             ABRASION LACERATION ANGER BOILS LONELINESS - PAIN
             OREGON GOIAS BAVARIA KENTUCKY MANITOBA ARIZONA MORAVIA
             - PROVINCE
             PLUTO URANUS MARS EARTH - PLANET)
   (:INIT (ORBITS PLUTO URANUS)
