(DEFINE (PROBLEM MYSTY-A-28)
   ...
   (:OBJECTS BEEF BROCCOLI MELON OKRA PAPAYA LETTUCE HAMBURGER
             ...
             LOBSTER PEA LEMON - FOOD
             INTOXICATION SATIETY EXPECTATION EMPATHY ENTERTAINMENT
             ACHIEVEMENT CURIOSITY - PLEASURE
             DEPRESSION GRIEF PROSTATITIS LONELINESS ABRASION DREAD SCIATICA
             HANGOVER LACERATION JEALOUSY ANXIETY ANGER BOILS ANGINA
             LACERATION-2 HANGOVER-4 ANGER-1 - PAIN
             BAVARIA GUANABARA QUEBEC - PROVINCE
             PLUTO VENUS EARTH SATURN - PLANET)
   (:INIT (EATS MELON BEEF)
