...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__search

#else
#  define SWIG_init    init_search

#endif
#define SWIG_name    "_search"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_replacemain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:replacemain",&obj0)) SWIG_fail;
  res1 = SWIG_AsArgcArgv(obj0, SWIGTYPE_p_p_char, &argc1, &argv1, &owner1);
  if (!SWIG_IsOK(res1)) {
    arg1 = 0; arg2 = 0;
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "replacemain" "', argument " "1"" of type '" "int ARGC, char **ARGV""'");
  } else {
    arg1 = static_cast< int >(argc1);
    arg2 = static_cast< char ** >(argv1);
  }
  result = (int)replacemain(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"replacemain", _wrap_replacemain, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
