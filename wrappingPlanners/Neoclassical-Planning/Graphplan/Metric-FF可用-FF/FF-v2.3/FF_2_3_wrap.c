...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__FF_2_3

#else
#  define SWIG_init    init_FF_2_3

#endif
#define SWIG_name    "_FF_2_3"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_FF_2_3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:FF_2_3",&obj0)) SWIG_fail;
  res1 = SWIG_AsArgcArgv(obj0, SWIGTYPE_p_p_char, &argc1, &argv1, &owner1);
  if (!SWIG_IsOK(res1)) {
    arg1 = 0; arg2 = 0;
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "FF_2_3" "', argument " "1"" of type '" "int ARGC, char **ARGV""'");
  } else {
    arg1 = (int)(argc1);
    arg2 = (char **)(argv1);
  }
  result = (int)FF_2_3(arg1,arg2);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"FF_2_3", _wrap_FF_2_3, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
