(DEFINE (PROBLEM STRIPS-MYSTY-18)
   ...
   (:OBJECTS PORK ONION FLOUNDER MUFFIN TUNA GRAPEFRUIT BROCCOLI
             ...
             POTATO STIMULATION LOVE LUBRICITY AESTHETICS EXPECTATION
             LEARNING CURIOSITY TRIUMPH ACHIEVEMENT UNDERSTANDING
             SATISFACTION ENTERTAINMENT INTOXICATION SATIETY EMPATHY REST
             EXCITEMENT LACERATION DREAD ANGINA PROSTATITIS JEALOUSY ABRASION
             HANGOVER DEPRESSION BOILS ANXIETY ANGER LONELINESS SCIATICA
             GRIEF LONELINESS-1 ANXIETY-2 GRIEF-4 ABRASION-8
             DEPRESSION-3 PROSTATITIS-7 DREAD-6 BOILS-16 SCIATICA-5 ANGER-15
             BOSNIA PENNSYLVANIA GOIAS OREGON URANUS JUPITER MARS VULCAN)
   (:INIT (FOOD PORK)
          (FOOD ONION)
          (FOOD FLOUNDER)
          (FOOD MUFFIN)
