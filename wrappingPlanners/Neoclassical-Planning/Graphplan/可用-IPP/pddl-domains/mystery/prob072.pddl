(DEFINE (PROBLEM STRIPS-MYSTY-31)
   ...
   (:OBJECTS PEAR ONION HOTDOG ENDIVE PAPAYA SCALLOP PORK BROCCOLI
             ...
             SCALLION POPOVER MELON RICE LETTUCE MARZIPAN UNDERSTANDING
             ENTERTAINMENT TRIUMPH AESTHETICS ACHIEVEMENT CURIOSITY STIMULATION
             LUBRICITY LEARNING EXPECTATION INTOXICATION SATISFACTION
             EXCITEMENT REST LOVE EMPATHY SATIETY REST-2 EMPATHY-1 SATIETY-4
             LEARNING-3 LOVE-8 INTOXICATION-7 ACHIEVEMENT-6 EXCITEMENT-5
             EXPECTATION-16 GRIEF PROSTATITIS ANGER HANGOVER JEALOUSY ANGINA DREAD
             ...
             PENNSYLVANIA GOIAS ARIZONA KENTUCKY SATURN NEPTUNE EARTH VENUS)
   (:INIT (FOOD PEAR)
          (FOOD ONION)
          (FOOD HOTDOG)
          (FOOD ENDIVE)
          ...
          (PLEASURE LEARNING-3)
          (PLEASURE LOVE-8)
          (PLEASURE INTOXICATION-7)
          (PLEASURE ACHIEVEMENT-6)
          (PLEASURE EXCITEMENT-5)
          (PLEASURE EXPECTATION-16)
          (PAIN GRIEF)
          (PAIN PROSTATITIS)
          (PAIN ANGER)
          (PAIN HANGOVER)
