(DEFINE (PROBLEM MYSTY-23)
   ...
   (:OBJECTS CANTELOPE ARUGULA CHOCOLATE SNICKERS LAMB TURKEY
             ...
             WURST HAM GRAPEFRUIT KALE CHERRY - FOOD
             UNDERSTANDING LUBRICITY EMPATHY TRIUMPH ENTERTAINMENT SATIETY
             AESTHETICS ACHIEVEMENT EXPECTATION CURIOSITY EXCITEMENT
             STIMULATION - PLEASURE
             PROSTATITIS LACERATION GRIEF ANGINA DEPRESSION LONELINESS DREAD
             ABRASION ANGER HANGOVER JEALOUSY BOILS ANXIETY SCIATICA
             ANXIETY-2 DREAD-1 LACERATION-4 HANGOVER-3 DEPRESSION-8 BOILS-7
             JEALOUSY-6 - PAIN
             MORAVIA QUEBEC OREGON GOIAS GUANABARA KENTUCKY ARIZONA
             PENNSYLVANIA BAVARIA SURREY - PROVINCE
             VENUS VULCAN MARS MERCURY - PLANET)
   (:INIT (ORBITS MARS MERCURY)
