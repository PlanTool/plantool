...
{
	"del",
	EvalDel,  /* EvalNODel: do not execute deletes */
	NoIdler,    /* EvalDel : execute deletes */
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	NoComputor,
...
ACTION aGoalDistanceHspUnreleffsAction=
{
	"goal-distance-hsp-unreleffs",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	ComputeGoalDistanceHspUnreleffs,
	NoCCForm
};
ACTION aGoalDistanceFFUnreleffsAction=
{
	"goal-distance-ff-unreleffs",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	ComputeGoalDistanceFFUnreleffs,
	NoCCForm
};
ACTION aGoalDistanceQualpreferencesAction=
{
	"goal-distance-qualpreferences",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	ComputeGoalDistanceQual,
	NoCCForm
};
ACTION aGoalDistanceFFPDDLPrefs=
{
	"goal-distance-ff-pddl-prefs",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	ComputeGoalDistanceFFPDDLPrefs,
	NoCCForm
};
ACTION aGoalDistanceNegAction=
{
	"goal-distance-neg",
	NoEvaluator,
	NoIdler,
...
ACTION aClosedlistLengthAction=
{
	"closedlist-length",
	NoEvaluator,
	NoIdler,
...
ACTION aSetHeuristicPreservedPropertyAction=
{
	"set-heuristic-preserved-property",
	EvalSetHeuristicPreservedProperty,
	EvalSetHeuristicPreservedProperty,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetQualpreferenceValueFnAction=
{
	"set-qualpreference-value-fn",
	EvalSetQualpreferenceValueFn,
	EvalSetQualpreferenceValueFn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetQualpreferenceNumberAction=
{
	"set-qualpreference-number",
	EvalSetQualpreferenceNumber,
	EvalSetQualpreferenceNumber,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetCountSatPrefsFnAction=
{
	"set-count-sat-prefs-fn",
	EvalSetCountSatPrefsFn,
	EvalSetCountSatPrefsFn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetOptimisticMetricFnAction=
{
	"set-optimistic-metric-fn",
	EvalSetOptimisticMetricFn,
	EvalSetOptimisticMetricFn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetPreferenceMultiplierAction=
{
	"set-preference-multiplier",
	EvalSetPreferenceMultiplier,
	EvalSetPreferenceMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetGoalOcclusionMultiplierAction=
{
	"set-goal-occlusion-multiplier",
	EvalSetGoalOcclusionMultiplier,
	EvalSetGoalOcclusionMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetPrecondOcclusionMultiplierAction=
{
	"set-precondition-occlusion-multiplier",
	EvalSetPrecondOcclusionMultiplier,
	EvalSetPrecondOcclusionMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetDiscountedMetricPriorityAction=
{
	"set-discounted-metric-priority",
	EvalSetDiscountedMetricPriority,
	EvalSetDiscountedMetricPriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetOptimisticMetricPriorityAction=
{
	"set-optimistic-metric-priority",
	EvalSetOptimisticMetricPriority,
	EvalSetOptimisticMetricPriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetBestRelaxedMetricPriorityAction=
{
	"set-discounted-metric-priority",
	EvalSetBestRelaxedMetricPriority,
	EvalSetBestRelaxedMetricPriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetPreferenceDistancePriorityAction=
{
	"set-discounted-metric-priority",
	EvalSetPreferenceDistancePriority,
	EvalSetPreferenceDistancePriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetMetricPriorityAction=
{
	"set-metric-priority",
	EvalSetMetricPriority,
	EvalSetMetricPriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetMetricMultiplierAction=
{
	"set-metric-multiplier",
	EvalSetMetricMultiplier,
	EvalSetMetricMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetDiscountedMetricMultiplierAction=
{
	"set-discounted-metric-multiplier",
	EvalSetDiscountedMetricMultiplier,
	EvalSetDiscountedMetricMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetBestMetricMultiplierAction=
{
	"set-best-metric-multiplier",
	EvalSetBestMetricMultiplier,
	EvalSetBestMetricMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetOptimisticMetricMultiplierAction=
{
	"set-optimistic-metric-multiplier",
	EvalSetOptimisticMetricMultiplier,
	EvalSetOptimisticMetricMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetGoalMultiplierAction=
{
	"set-goal-multiplier",
	EvalSetGoalMultiplier,
	EvalSetGoalMultiplier,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetHeuristicExponentAction=
{
	"set-heuristic-exponent",
	EvalSetHeuristicExponent,
	EvalSetHeuristicExponent,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetMetricDiscountAction=
{
	"set-metric-discount",
	EvalSetMetricDiscount,
	EvalSetMetricDiscount,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetHelpfulListPriority=
{
	"set-helpful-list-priority",
	EvalSetHelpfulListPriority,
	EvalSetHelpfulListPriority,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetPostActionSequenceAction=
{
	"set-post-action-sequence",
	EvalSetPostActionSequence,
	EvalSetPostActionSequence,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aSetBDFPreferenceAction=
{
	"set-bdf-preference",
	EvalSetBDFPreference,
	EvalSetBDFPreference,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aFFRelPlanSimpOnAction=
{
	"ff-relplan-simplification-on",
	EvalFFRelPlanSimpOn,
	EvalFFRelPlanSimpOn,
	ProgressAtomic,
	CurrentAtomic,
...
ACTION aFFRelPlanSimpOffAction=
{
	"ff-relplan-simplification-off",
	EvalFFRelPlanSimpOff,
	EvalFFRelPlanSimpOff,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseShowExpandedPlansOffAction=
{
	"verbose-show-expanded-plans-off",
	EvalVerboseShowExpandedPlansOff,
	EvalVerboseShowExpandedPlansOff,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseShowExpandedPlansOnAction=
{
	"verbose-show-expanded-plans-on",
	EvalVerboseShowExpandedPlansOn,
	EvalVerboseShowExpandedPlansOn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseShowExpandedWorldsOffAction=
{
	"verbose-show-expanded-worlds-off",
	EvalVerboseShowExpandedWorldsOff,
	EvalVerboseShowExpandedWorldsOff,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseShowExpandedWorldsOnAction=
{
	"verbose-show-expanded-plans-on",
	EvalVerboseShowExpandedWorldsOn,
	EvalVerboseShowExpandedWorldsOn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseFFShowRelaxedPlansOffAction=
{
	"verbose-ff-show-relaxed-plans-off",
	EvalVerboseFFShowRelaxedPlansOff,
	EvalVerboseFFShowRelaxedPlansOff,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseFFShowRelaxedPlansOnAction=
{
	"verbose-ff-show-relaxed-plans-on",
	EvalVerboseFFShowRelaxedPlansOn,
	EvalVerboseFFShowRelaxedPlansOn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseFFShowRelaxedWorldsOffAction=
{
	"verbose-ff-show-relaxed-worlds-off",
	EvalVerboseFFShowRelaxedWorldsOff,
	EvalVerboseFFShowRelaxedWorldsOff,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aVerboseFFShowRelaxedWorldsOnAction=
{
	"verbose-ff-show-relaxed-plans-on",
	EvalVerboseFFShowRelaxedWorldsOn,
	EvalVerboseFFShowRelaxedWorldsOn,
	ProgressAtomic,
	CurrentAtomic,
	NoGenerator,
...
ACTION aGetBestRelaxedMetricAction=
{
	"get-best-relaxed-metric",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
...
ACTION aGetNoWorldFixedPointsAction=
{
	"get-no-world-fixed-points",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
...
ACTION aGetNoRealFixedPointsAction=
{
	"get-no-real-fixed-points",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
	NoGenerator,
	ComputeGetNumberRealFixedPoints,
	NoCCForm
};
ACTION aGetBestPreferenceValueAction=
{
	"get-best-preference-value",
	NoEvaluator,
	NoIdler,
	NoProgressor,
	NoCurrentor,
...
)
{
	...
	pa->psName=IdentAllocAndPos(pa->psName,&nPosition);
	EXIT("InitActionName");
}
...
)
{
	...
	if(plList->nType==ATOM_LISTP)
	{
			...
			pl->nType==ATOM_INTEGER||pl->nType==ATOM_STRING))
		{
			...
			{
			  pc1->pfForm->psName=StrAllocAndPos(pl->psName,&nPosition);
			  pc1->pfForm->nHashPos=nPosition;
			  pc1->pfForm->uValue.psString=pc1->pfForm->psName;
			}
			else
			{
			  pc1->pfForm->psName=IdentAllocAndPos(pl->psName,&nPosition);
			  pc1->pfForm->nHashPos=nPosition;
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_TRUE])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_WORLD_COUNTER])||
			StringEqQ(pl->psName,apsStringTab[STRING_CLOSEDLIST_LENGTH])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_FF_RELPLAN_SIMPLIFICATION_ON])||
			StringEqQ(pl->psName,apsStringTab[STRING_FF_RELPLAN_SIMPLIFICATION_OFF])||
 		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_PLANS_ON])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_PLANS_OFF])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_WORLDS_ON])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_WORLDS_OFF])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_PLANS_ON])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_PLANS_OFF])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_WORLDS_ON])||
		        StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_WORLDS_OFF])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_GET_BEST_RELAXED_METRIC])||
			StringEqQ(pl->psName,apsStringTab[STRING_GET_NO_WORLD_FIXED_POINTS])||
			StringEqQ(pl->psName,apsStringTab[STRING_GET_NO_REAL_FIXED_POINTS])||
			StringEqQ(pl->psName,apsStringTab[STRING_GET_BEST_PREFERENCE_VALUE])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_PRINT_PDDL_PLAN])||
		        ...
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE])||
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_HSP_UNRELEFFS])||
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_FF_PDDL_PREFS])||
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_FF_UNRELEFFS])||
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_QUALPREFERENCES])||
		        StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_NEG]))
		{
			...
			if(nArgs)
			{
				ErrorMessage("ListToFormula: (1)  Too many arguments to %s formula\n",
					pl->psName);
				EXIT("ListToFormula");
				return NULL;
			}
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_WORLD_COUNTER]))
				pc=CompileArgForm(&aWorldCounterAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_CLOSEDLIST_LENGTH]))
				pc=CompileArgForm(&aClosedlistLengthAction,NULL);
...
//				pc=CompileArgForm(&aWorldHeuristicRankAction,NULL);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_FF_RELPLAN_SIMPLIFICATION_ON]))
				pc=CompileArgForm(&aFFRelPlanSimpOnAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_FF_RELPLAN_SIMPLIFICATION_OFF]))
				pc=CompileArgForm(&aFFRelPlanSimpOffAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_PLANS_ON]))
				pc=CompileArgForm(&aVerboseShowExpandedPlansOnAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_PLANS_OFF]))
				pc=CompileArgForm(&aVerboseShowExpandedPlansOffAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_WORLDS_ON]))
				pc=CompileArgForm(&aVerboseShowExpandedWorldsOnAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_SHOW_EXPANDED_WORLDS_OFF]))
				pc=CompileArgForm(&aVerboseShowExpandedWorldsOffAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_PLANS_ON]))
				pc=CompileArgForm(&aVerboseFFShowRelaxedPlansOnAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_PLANS_OFF]))
				pc=CompileArgForm(&aVerboseFFShowRelaxedPlansOffAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_WORLDS_ON]))
				pc=CompileArgForm(&aVerboseFFShowRelaxedWorldsOnAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_VERBOSE_FF_SHOW_RELAXED_WORLDS_OFF]))
				pc=CompileArgForm(&aVerboseFFShowRelaxedWorldsOffAction,NULL);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GET_BEST_RELAXED_METRIC]))
				pc=CompileArgForm(&aGetBestRelaxedMetricAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GET_BEST_PREFERENCE_VALUE]))
				pc=CompileArgForm(&aGetBestPreferenceValueAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GET_NO_WORLD_FIXED_POINTS]))
				pc=CompileArgForm(&aGetNoWorldFixedPointsAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GET_NO_REAL_FIXED_POINTS]))
				pc=CompileArgForm(&aGetNoRealFixedPointsAction,NULL);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE]))
			        pc=CompileArgForm(&aGoalDistanceAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_HSP_UNRELEFFS]))
			        pc=CompileArgForm(&aGoalDistanceHspUnreleffsAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_FF_PDDL_PREFS]))
			        pc=CompileArgForm(&aGoalDistanceFFPDDLPrefs,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_FF_UNRELEFFS]))
			        pc=CompileArgForm(&aGoalDistanceFFUnreleffsAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_QUALPREFERENCES]))
			        pc=CompileArgForm(&aGoalDistanceQualpreferencesAction,NULL);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_GOAL_DISTANCE_NEG]))
			        pc=CompileArgForm(&aGoalDistanceNegAction,NULL);
			else
			{
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_NOT])||
		        StringEqQ(pl->psName,apsStringTab[STRING_UNOT])||
		   ...
		   //			StringEqQ(pl->psName,apsStringTab[STRING_ENABLE])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_FN])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_HEURISTIC_PRESERVED_PROPERTY])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_QUALPREFERENCE_VALUE_FN])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_COUNT_SAT_PREFS_FN])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_TOTAL_PREFS_FN])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_FN])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_GOAL_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_PLAN_TIMEOUT])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCE_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_GOAL_OCCLUSION_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_PRECOND_OCCLUSION_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_DISCOUNTED_METRIC_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_BEST_METRIC_MULTIPLIER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_HEURISTIC_EXPONENT])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_DISCOUNT])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_MULTIPLIER])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_SET_MERGE_FN_TYPE])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_QUALPREFERENCE_NUMBER])||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_PRINT_WORLD_FN])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_DISCOUNTED_METRIC_PRIORITY])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_PRIORITY])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_PRIORITY])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_BEST_RELAXED_METRIC_PRIORITY])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCE_DISTANCE_PRIORITY])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_ASTAR]))
		{
			...
			if(nArgs!=1)
			{
				ErrorMessage("ListToFormula:  (2) Too %s arguments to %s formula\n",
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_UNOT]))
				pc=CompileArgForm(&aUNotAction,pcStart);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_FN]))
				pc=CompileArgForm(&aSetMetricFnAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_HEURISTIC_PRESERVED_PROPERTY]))
				pc=CompileArgForm(&aSetHeuristicPreservedPropertyAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_QUALPREFERENCE_VALUE_FN]))
				pc=CompileArgForm(&aSetQualpreferenceValueFnAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_COUNT_SAT_PREFS_FN]))
				pc=CompileArgForm(&aSetCountSatPrefsFnAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_TOTAL_PREFS_FN]))
				pc=CompileArgForm(&aSetTotalPrefsFnAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_FN]))
				pc=CompileArgForm(&aSetOptimisticMetricFnAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_GOAL_MULTIPLIER]))
				pc=CompileArgForm(&aSetGoalMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_DISCOUNTED_METRIC_PRIORITY]))
			  pc=CompileArgForm(&aSetDiscountedMetricPriorityAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_PRIORITY]))
			  pc=CompileArgForm(&aSetMetricPriorityAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_PRIORITY]))
			  pc=CompileArgForm(&aSetOptimisticMetricPriorityAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_BEST_RELAXED_METRIC_PRIORITY]))
			  pc=CompileArgForm(&aSetBestRelaxedMetricPriorityAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCE_DISTANCE_PRIORITY]))
			  pc=CompileArgForm(&aSetPreferenceDistancePriorityAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_PLAN_TIMEOUT]))
				pc=CompileArgForm(&aSetPlanTimeoutAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCE_MULTIPLIER]))
				pc=CompileArgForm(&aSetPreferenceMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_GOAL_OCCLUSION_MULTIPLIER]))
				pc=CompileArgForm(&aSetGoalOcclusionMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_PRECOND_OCCLUSION_MULTIPLIER]))
				pc=CompileArgForm(&aSetPrecondOcclusionMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_QUALPREFERENCE_NUMBER]))
				pc=CompileArgForm(&aSetQualpreferenceNumberAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_MULTIPLIER]))
				pc=CompileArgForm(&aSetMetricMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_DISCOUNTED_METRIC_MULTIPLIER]))
				pc=CompileArgForm(&aSetDiscountedMetricMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_BEST_METRIC_MULTIPLIER]))
				pc=CompileArgForm(&aSetBestMetricMultiplierAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_HEURISTIC_EXPONENT]))
				pc=CompileArgForm(&aSetHeuristicExponentAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_METRIC_DISCOUNT]))
				pc=CompileArgForm(&aSetMetricDiscountAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_OPTIMISTIC_METRIC_MULTIPLIER]))
				pc=CompileArgForm(&aSetOptimisticMetricMultiplierAction,pcStart);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_MERGE_FN_TYPE]))
				pc=CompileArgForm(&aSetMergeFnTypeAction,pcStart);
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_IMPLIES])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_PRINT_PDDL3_PLAN])||
			StringEqQ(pl->psName,apsStringTab[STRING_PLUS_EQ])||
			StringEqQ(pl->psName,apsStringTab[STRING_MINUS_EQ]) ||
			StringEqQ(pl->psName,apsStringTab[STRING_SET_HELPFUL_LIST_PRIORITY]))
		{
			pcStart=NULL;				/* initialize listhead */
			pcEnd=(CELLP)&pcStart;
			nArgs=0;
			...
			if(nArgs!=2)
			{
				ErrorMessage("ListToFormula: (3) Too %s arguments to %s formula\n",
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_PRINT_PDDL3_PLAN]))
				pc=CompileArgForm(&aPrintPddl3PlanAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_MINUS_EQ]))
				pc=CompileArgForm(&aMinusEqAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_HELPFUL_LIST_PRIORITY]))
				pc=CompileArgForm(&aSetHelpfulListPriority,pcStart);
			else
			{
				ErrorMessage("Internal error\n");
				EXIT("ListToFormula");
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_IF_THEN_ELSE])||
		        StringEqQ(pl->psName,apsStringTab[STRING_CONDITIONAL_EXP])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_T_UNTIL]))
		{
			...
			if(nArgs!=3)
			{
				ErrorMessage("ListToFormula: (4) Too %s arguments to %s formula\n",
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_CONDITIONAL_EXP]))
				pc=CompileArgForm(&aConditionalExpAction,pcStart);
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_SET_GOAL])||
		   StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCES])||
		   ...
		   StringEqQ(pl->psName,apsStringTab[STRING_PRINT_DELTA_TIME]))
		{
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_PREFERENCES]))
				pc=CompileArgForm(&aSetPreferencesAction,pcStart);
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_AND])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_SDEL])||
			StringEqQ(pl->psName,apsStringTab[STRING_PRINT])||
			StringEqQ(pl->psName,apsStringTab[STRING_PRINT_STRING])||
		   ...
		   //StringEqQ(pl->psName,apsStringTab[STRING_LOG])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_DEF_ADL_H_OPERATOR])||
			...
			StringEqQ(pl->psName,apsStringTab[STRING_SET_INITIALIZATION_SEQUENCE])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_POSTACTION_SEQUENCE])||
		        StringEqQ(pl->psName,apsStringTab[STRING_SET_BDF_PREFERENCE])||
		...
		{
		  bADLPre= StringEqQ(pl->psName,apsStringTab[STRING_DEF_ADL_OPERATOR]) || StringEqQ(pl->psName,apsStringTab[STRING_DEF_ADL_H_OPERATOR]);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SDEL]))
				pc=CompileArgForm(&aSDelAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_PRINT]))
				pc=CompileArgForm(&aPrintAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_PRINT_STRING]))
				pc=CompileArgForm(&aPrintStringAction,pcStart);
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_DEF_ADL_H_OPERATOR]))
			{
				pc=CompileArgForm(&aDefADLHOperatorAction,pcStart);
				bADLPre=FALSE;
			}
			...
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_POSTACTION_SEQUENCE]))
				pc=CompileArgForm(&aSetPostActionSequenceAction,pcStart);
			else if(StringEqQ(pl->psName,apsStringTab[STRING_SET_BDF_PREFERENCE]))
				pc=CompileArgForm(&aSetBDFPreferenceAction,pcStart);
		...
		if(StringEqQ(pl->psName,apsStringTab[STRING_ISPEC]))
		{
			...
			if(pl4->plNext)
			{
				ErrorMessage("ListToFormula: (5) Too many arguments to %s formula\n",
					pl->psName);
				EXIT("ListToFormula");
				return NULL;
			}
	...
	if(plList->nType==ATOM_STRING)
	{
	  pf->psName=StrAllocAndPos(plList->psName,&nPosition);
	...
	{
	        int nPosition;
	        pf->psName=IdentAllocAndPos(plList->psName,&nPosition);
		pf->nHashPos=nPosition;
...
)
{
	...
	pf->psName=IdentAllocAndPos(paAction->psName,&nPosition);
	pf->nHashPos=nPosition;
	pf->pcArgs=pcArgs;
	EXIT("CompileArgForm");
	return pc;
...
)
{
	...
	pf->psName=IdentAllocAndPos(psName,&nPosition);
	pf->nHashPos=nPosition;
	pf->pcArgs=pcArgs;
...
)
{
	...
	pf->psName=IdentAllocAndPos(pf->paAction->psName,&nPosition);
	pf->nHashPos=nPosition;
	pf->pcVars=pcVariables;
	pf->pcGenLit=pcGenLit;
	pcGenLit->pcNext=NULL;
