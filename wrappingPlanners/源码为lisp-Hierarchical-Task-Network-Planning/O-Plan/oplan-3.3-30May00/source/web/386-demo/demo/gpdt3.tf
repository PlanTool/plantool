...
;;; Updated: Sun May  9 03:05:53 1999 by Jeff Dalton
;;; Copyright: (c) 1997, AIAI, University of Edinburgh

types city               = (Abyss Barnacle Calypso Delta Exodus),
      fast_vehicle       = (GT1 GT2),
      slow_vehicle       = (GT3 GT4 GT5 GT6),
      fleet_of_trucks    = (FT1 FT2),
      helicopter         = (H1 H2),
      repair_team        = (RT1 RT2),
      repair_equipment   = (RE1 RE2),
      medical_team       = (MT1 MT2 MT3),
      medical_equipment  = (ME1 ME2 ME3),
...
schema evacuate_injured_using_helicopters_and_fast_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
...
schema evacuate_injured_using_helicopters_and_slow_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
...
schema evacuate_injured_using_fast_ground_vehicles;
...
schema evacuate_injured_using_fast_and_slow_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?mt = ?{type medical_team},
       ?me = ?{type medical_equipment},
...
schema evacuate_injured_using_slow_ground_vehicles;
...
schema evacuate_population_using_a_fast_ground_vehicle;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type fleet_of_trucks},
       ?et = ?{type evacuation_team},
       ?at = ?{type city};
...
schema evacuate_population_using_a_slow_ground_vehicle;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type fleet_of_trucks},
       ?et = ?{type evacuation_team},
       ?at = ?{type city};
...
schema evacuate_with_medical_team_using_helicopters_and_fast_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type fast_vehicle},
       ?v3 = ?{type fleet_of_trucks},
...
schema evacuate_with_medical_team_using_helicopters_and_slow_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type slow_vehicle},
       ?v3 = ?{type fleet_of_trucks},
...
schema evacuate_with_medical_team_using_fast_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type fast_vehicle},
       ?v3 = ?{type fleet_of_trucks},
       ?mt = ?{type medical_team},
...
schema evacuate_with_medical_team_using_fast_and_slow_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?v3 = ?{type fleet_of_trucks},
       ?mt = ?{type medical_team},
...
schema evacuate_with_medical_team_using_slow_ground_vehicles;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?v3 = ?{type fleet_of_trucks},
       ?mt = ?{type medical_team},
...
schema send_medical_supplies_using_a_fast_ground_vehicle;
  vars ?v1 = ?{type fast_vehicle},
       ?ms = ?{type medical_supplies},
       ?at = ?{type city};
  expands {send_medical_supplies ?at};
...
schema send_medical_supplies_using_a_slow_ground_vehicle;
  vars ?v1 = ?{type slow_vehicle},
       ?ms = ?{type medical_supplies},
       ?at = ?{type city};
  expands {send_medical_supplies ?at};
...
schema send_emergency_food_using_a_fast_ground_vehicle;
  vars ?v1 = ?{type fast_vehicle},
       ?ef = ?{type emergency_food},
       ?at = ?{type city};
  expands {send_emergency_food ?at};
...
schema send_emergency_food_using_a_slow_ground_vehicle;
  vars ?v1 = ?{type slow_vehicle},
       ?ef = ?{type emergency_food},
       ?at = ?{type city};
  expands {send_emergency_food ?at};
...
schema send_medical_team_using_helicopters_and_fast_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type fast_vehicle},
       ?mt = ?{type medical_team},
...
schema send_medical_team_using_helicopters_and_slow_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type slow_vehicle},
       ?mt = ?{type medical_team},
...
schema send_medical_team_using_fast_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type fast_vehicle},
       ?mt = ?{type medical_team},
       ?me = ?{type medical_equipment},
...
schema send_medical_team_using_fast_and_slow_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?mt = ?{type medical_team},
       ?me = ?{type medical_equipment},
...
schema send_medical_team_using_slow_ground_vehicles;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?mt = ?{type medical_team},
       ?me = ?{type medical_equipment},
...
schema repair_gas_leak_using_helicopters_and_fast_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type fast_vehicle},
       ?tm = ?{type repair_team},
...
schema repair_gas_leak_using_helicopters_and_slow_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type slow_vehicle},
       ?tm = ?{type repair_team},
...
schema repair_gas_leak_using_fast_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type fast_vehicle},
       ?tm = ?{type repair_team},
       ?eq = ?{type repair_equipment},
...
schema repair_gas_leak_using_fast_and_slow_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?tm = ?{type repair_team},
       ?eq = ?{type repair_equipment},
...
schema repair_gas_leak_using_slow_ground_vehicles;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?tm = ?{type repair_team},
       ?eq = ?{type repair_equipment},
...
schema defuse_terrorist_bomb_using_a_fast_ground_vehicle;
  vars ?v1 = ?{type fast_vehicle},
       ?bs = ?{type bomb_squad},
       ?at = ?{type city};
  expands {defuse_terrorist_bomb ?at};
...
schema defuse_terrorist_bomb_using_a_slow_ground_vehicle;
  vars ?v1 = ?{type slow_vehicle},
       ?bs = ?{type bomb_squad},
       ?at = ?{type city};
  expands {defuse_terrorist_bomb ?at};
...
schema build_emergency_housing_using_helicopters_and_slow_ground_vehicles;
  vars ?wt = ?{type flying_weather},
       ?v1 = ?{type helicopter},
       ?v2 = ?{type slow_vehicle},
       ?v3 = ?{type fleet_of_trucks},
...
schema build_emergency_housing_using_slow_ground_vehicles;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?v3 = ?{type fleet_of_trucks},
       ?bt = ?{type building_team},
...
schema repair_power_station_turbine_using_fast_ground_vehicles;
  vars ?v1 = ?{type fast_vehicle},
       ?v2 = ?{type fast_vehicle},
       ?tm = ?{type repair_team},
       ?eq = ?{type repair_equipment},
...
schema repair_power_station_turbine_using_slow_ground_vehicles;
  vars ?v1 = ?{type slow_vehicle},
       ?v2 = ?{type slow_vehicle},
       ?tm = ?{type repair_team},
       ?eq = ?{type repair_equipment},
...
schema provide_immediate_assistance_using_a_fast_ground_vehicle;
...
schema provide_immediate_assistance_using_a_slow_ground_vehicle;
...
schema shut_down_power_station_using_a_fast_ground_vehicle;
  vars ?v = ?{type fast_vehicle},
       ?e = ?{type engineer},
       ?a = ?{type city};
  expands {shut_down_power_station ?a};
...
schema shut_down_power_station_using_a_slow_ground_vehicle;
  vars ?v = ?{type slow_vehicle},
       ?e = ?{type engineer},
       ?a = ?{type city};
  expands {shut_down_power_station ?a};
